...
public class MyParameterProcessor {
    static Logger LOGGER = LoggerFactory.getLogger(MyParameterProcessor.class);
...
//                }
            ...
            bp.setIn(StringUtils.isNotEmpty(param.getParamType()) ? param.getParamType() : "body");
//            abstractSerializableParameter.setType(StringUtils.isNotEmpty(param.getDataType()) ? param.getDataType() : "");
            if (StringUtils.isNotEmpty(param.getDescription())) {
