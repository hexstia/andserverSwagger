...
// 	        url : "http://petstore.swagger.io/v2/swagger.json",
        url : window.location.protocol + "//" + window.location.host + "/swagger/api/swagger.json",
//         url : "http://192.168.6.109:8080/test.json",
//        url : "http://192.168.6.109:8080/swagger/api/swagger.json",
        dataType: "json",
        type: "get",
        async: false,
